...
class TestSuite:
	...
	def invoke(self):
		...
		self.add_credit("DANNON", 1000, "2020-11-02T14:00:00Z");
		self.add_credit("UNILEVER", 200, "2020-10-31T11:00:00Z");
		self.add_credit("DANNON", -200, "2020-10-31T15:00:00Z");
		self.add_credit("MILLER COORS", 10000, "2020-11-01T14:00:00Z");
		self.add_credit("DANNON", 300, "2020-10-31T10:00:00Z");
